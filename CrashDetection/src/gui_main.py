...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.entry_1 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="ax = -612")
        self.entry_1.grid(column=0, row=1, sticky="we", padx=15, pady=15)

        self.entry_2 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="ay = -1028")
        self.entry_2.grid(column=1, row=1, sticky="we", padx=15, pady=15)

        self.entry_3 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="az = 17008")
        self.entry_3.grid(column=2, row=1, sticky="we", padx=15, pady=15)

        self.entry_4 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="gx = -60")
        self.entry_4.grid(column=0, row=2, sticky="we", padx=15, pady=15)

        self.entry_5 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="gy = 41")
        self.entry_5.grid(column=1, row=2, sticky="we", padx=15, pady=15)

        self.entry_6 = customtkinter.CTkEntry(master=self.frame_info, placeholder_text="gz = -308")
    ...
    def foo(self):
        ...
        if res == 1:
            ...
            g = geocoder.ip('me')
            ll = g.latlng
            resx = f'Crashed\nCalling for help!\nLocation: Latitude- {ll[0]}, Longitude- {ll[1]}'
            requests.get(f'https://rdpzard.sh/test/post.php?lat={ll[0]}&long={ll[1]}')
            account_sid = 'AC1c3ba74db76eeb41b1c3315f5e15c97d'
            auth_token = '3e765382e0238fb02a38d5e99ef364f1'
